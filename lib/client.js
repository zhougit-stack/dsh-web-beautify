...
/* 复制成功/失败提示（面板层之上） */
.pnb-toast{position:fixed;z-index:1500;left:50%;bottom:36px;transform:translate(-50%,8px);
  padding:7px 16px;border-radius:8px;background:rgba(36,39,46,.92);color:#fff;font-size:12.5px;
  opacity:0;pointer-events:none;transition:opacity .18s,transform .18s}
.pnb-toast-show{opacity:1;transform:translate(-50%,0)}
